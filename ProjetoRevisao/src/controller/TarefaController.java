...
public class TarefaController {
    ...
    public void removerTarefa(TarefaModel tarefaModel){
        boolean tarefaRemovido = false;
        for (TarefaModel tarefa : listaDeTarefas){
            if(tarefaModel.getId_titulo()){
                tarefaDao.removerTarefa(tarefaModel);
                tarefaRemovido = true;
                break;
            }
    tarefaView.exibeMensagemRemovida(tarefaModel);
        }
    }
